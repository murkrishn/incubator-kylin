...
public class MonitorMetaManager {
    ...
    static String hbaseZookeeperQuorum = null;
    ...
    public static void init() throws Exception {
        ...
        MonitorMetaManager.hbaseZookeeperQuorum = conf.get(HConstants.ZOOKEEPER_QUORUM);
        MonitorMetaManager.connection = HBaseConnection.get(hbaseZookeeperQuorum);
