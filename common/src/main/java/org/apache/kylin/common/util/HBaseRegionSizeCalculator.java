...
public class HBaseRegionSizeCalculator {
    ...
    public HBaseRegionSizeCalculator(String tableName , Connection hbaseConnection) throws IOException {
        this(hbaseConnection.getTable(TableName.valueOf(tableName)), hbaseConnection.getAdmin(), hbaseConnection);
    }

    /** Constructor for unit testing */
    HBaseRegionSizeCalculator(Table table, Admin hBaseAdmin, Connection hbaseConnection) throws IOException {
        ...
        try {
            ...
            logger.info("Calculating region sizes for table \"" + new String(table.getName().toString()) + "\".");
